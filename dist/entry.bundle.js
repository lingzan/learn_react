...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appleBasket = __webpack_require__(53);
	...
	var store = (0, _reactRedux.createStore)(_appleBasket2.default);
	var rootEl = document.getElementById('root');

	var render = function render() {
			return ReactDOM.render(React.createElement('app', { store: store }), rootEl);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AppleItem = __webpack_require__(54);

	var _AppleItem2 = _interopRequireDefault(_AppleItem);

	var _appleAction = __webpack_require__(55);
			...
			value: function render() {
				...
				return React.createElement(
					...
					React.createElement(
						...
						{ className: 'appleList' },
						state.apples.map(function (apple) {
							return React.createElement(_AppleItem2.default, { state: apple, action: { eatApple: function eatApple(id) {
										return dispatch(_appleAction2.default.eatApple(id));
									} }, key: apple.id });
						}),
						React.createElement(
							'div',
					...
					React.createElement(
						...
						React.createElement(
							...
							{ onClick: function onClick() {
									return dispatch(_appleAction2.default.pickApple());
								} },
							'\u6458\u82F9\u679C'
						)
					)
	...
	exports.default = (0, _reactRedux.connect)(selectState)(applebasket);
	            ...
	            */
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'apple' },
	                    _react2.default.createElement('img', { src: '../images/apple.png', alt: '' })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'info' },
...
/***/ function(module, exports) {
	...
	var actions = {
	    ...
	    failPickApple: function failPickApple(error) {
	        return {
